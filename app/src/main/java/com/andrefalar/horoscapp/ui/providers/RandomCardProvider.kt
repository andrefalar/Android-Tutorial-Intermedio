package com.andrefalar.horoscapp.ui.providers

import com.andrefalar.horoscapp.R
import com.andrefalar.horoscapp.ui.model.LuckyModel
...
class RandomCardProvider @Inject constructor() {
    ...
    // Devuelve una carta con su imgen correspondiente aleatoriamente
